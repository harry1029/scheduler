...
const state = {
  ...
  appointments: {
    ...
    "2": { 
      id: 2, 
      time: "1pm", 
      interview: { student: "Harry Jiang", interviewer: 1} 
    },
    "3": {
      id: 3,
      time: "2pm",
...
// getAppointmentsForDay Test Cases
...
// getInterviewersForDay Test Cases
...
test("getInterviewersForDayy returns an empty array when the day is not found", () => {
  const result = getInterviewersForDay(state, "Wednesday");
  expect(result.length).toEqual(0);
});


// getInterview Test Cases
